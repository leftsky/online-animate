      ...
      <div class="space-y-4">
        ...
        <div class="space-y-2">
          ...
          <div class="flex gap-2">
            <Button 
              variant="outline" 
              :class="{ 'bg-primary text-primary-foreground': mode === 'upload' }"
            ...
            <Button 
              variant="outline" 
              :class="{ 'bg-primary text-primary-foreground': mode === 'select' }"
        ...
        <div v-if="mode === 'select'" class="space-y-2">
          ...
          >
            ...
            <div v-else class="space-y-2">
              ...
              <Button variant="outline" size="sm" @click.stop="clearResource">
                重新选择
              </Button>
            </div>
          </div>
...
import { Loader2, Image, Upload } from 'lucide-vue-next';
