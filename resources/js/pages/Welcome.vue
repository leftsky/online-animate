...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[#0a0a0a] lg:justify-center lg:p-8">
        ...
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col overflow-hidden rounded-lg lg:max-w-4xl lg:flex-col">
                <div
                ...
                >
                    <h1 class="mb-4 text-3xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">创造精彩动画</h1>
                    <p class="mb-6 text-lg text-[#706f6c] dark:text-[#A1A09A]">
                        专业的在线动画制作平台，让您的创意变为现实。<br />无需复杂软件，在浏览器中即可制作精美动画。
                    </p>
                    <div class="mb-6 grid gap-4 lg:mb-8">
                        <div class="flex items-center gap-4 rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 p-4 dark:from-blue-900/20 dark:to-indigo-900/20">
                            ...
                            <div>
                                <h3 class="font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">简单易用</h3>
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">直观的界面设计，无需专业技能即可上手</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-4 rounded-lg bg-gradient-to-r from-green-50 to-emerald-50 p-4 dark:from-green-900/20 dark:to-emerald-900/20">
                            ...
                            <div>
                                <h3 class="font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">实时预览</h3>
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">所见即所得，实时查看动画效果</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-4 rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 p-4 dark:from-purple-900/20 dark:to-pink-900/20">
                            ...
                            <div>
                                <h3 class="font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">多格式导出</h3>
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">支持GIF、MP4、WebM等多种格式导出</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col gap-3 sm:flex-row">
                        <Link
                            v-if="!$page.props.auth.user"
                            :href="route('register')"
                            class="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-3 text-sm font-medium text-white shadow-lg transition-all hover:from-blue-700 hover:to-purple-700 hover:shadow-xl"
                        >
                            免费开始创作
                        </Link>
                        <Link
                        ...
                        <button
                            class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-6 py-3 text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50 hover:shadow-md dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                        >
                            观看演示
                        </button>
                    </div>
