        ...
        <div class="min-h-screen bg-background">
            <div class="container mx-auto p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-2 text-muted-foreground">管理您的场景、人物和物品资源</p>
                </div>
                ...
                <!-- 内容区域 -->
                <div v-if="activeTab === 'characters'" class="flex h-[calc(100vh-200px)] gap-6">
                    <!-- 左侧人物列表 -->
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <div class="mt-1 flex items-center gap-2">
                                            <span class="text-xs text-muted-foreground">{{
                                                getGenderText((character as MediaCharacter).gender)
                                            }}</span>
...
import { ChevronDown, Image, Library, MoreVertical, Package, Plus, Search, Trash2, Upload, Users } from 'lucide-vue-next';
...
const loadResources = async () => {
    ...
    try {
        ...
        if (activeTab.value === 'characters' && !selectedCharacter.value && resources.value.length > 0) {
            const firstCharacterWithModel = resources.value.find((resource) => 'gender' in resource && hasModelFile(resource as MediaCharacter)) as
                | MediaCharacter
                | undefined;
